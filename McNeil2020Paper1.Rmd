...
This markdown script is the first of two scripts reproducing analyses in the paper "Modelling volatile time series using v-transforms and copulas" by Alexander J.~McNeil (2020).
